...
// Test
describe('karmia-database-adapter-memory', function () {
        ...
        describe('Should sync database', function () {
            it('Promise', function (done) {
                ...
                database.define(key, schema).sync().then(function () {
                    expect(database.tables[key].constructor.name).to.be('KarmiaDatabaseAdapterMemoryTable');
    ...
    describe('table', function () {
        ...
        it('Should get table', function (done) {
            const table = database.table(key);
            expect(table.constructor.name).to.be('KarmiaDatabaseAdapterMemoryTable');
    ...
    describe('sequence', function() {
        ...
        it('Should get sequence', function (done) {
            ...
            expect(sequence.constructor.name).to.be('KarmiaDatabaseAdapterMemorySequence');
        ...
        describe('model', function () {
            it('Promise', function (done) {
                ...
                sequence.model().then(function (result) {
                    expect(result.constructor.name).to.be('Object');
            ...
            it('Callback', function (done) {
                ...
                sequence.model(function (error, result) {
                    if (error) {
                        return done(error);
                    }
    ...
    describe('suite', function () {
        ...
        it('Should create table suite', function (done) {
            ...
            expect(suite.constructor.name).to.be('KarmiaDatabaseAdapterMemoryTableSuite');
        ...
        describe('set', function () {
            ...
            describe('Should insert item', function () {
                it('Promise', function (done) {
                    const suite = database.suite(key, tables, data.user_id);
                    suite.get().then(function (result) {
                        expect(result).to.be(null);
            ...
            describe('Should update item', function () {
                ...
                it('Callback', function (done) {
                    ...
                    suite.get().then(function (result) {
                        ...
                        return suite.get({user_id: data.user_id});
                    }).then(function (result) {
                        Object.keys(updated).forEach(function (key) {
                            expect(updated[key]).to.be(result[key]);
                        });
